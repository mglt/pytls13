  ...
  def __init__( self ):
    ...
    #    'ecdhe_authentication' : True, ## ecdhe indicates certificate based authentication
        ...
        'signature_algorithms' : [ 'rsa_pkcs1_sha256', 'rsa_pkcs1_sha384', \
                ...
                'rsa_pss_pss_sha256', 'ed25519', 'ed448', 'rsa_pkcs1_sha1' ],
        ...
        'ephemeral_method' : 'cs_generated', ## cs_generated / e_generated \
                                             ## when ECDHE is needed. \
                                             ## otherwise can be set to 'no_secret'
      ...
      'cs' :{
        ( 'tls13', 'v1' ) : {
#          'public_key': ['pytls13/src/pytls13/clt_cs/_Ed25519PublicKey-ed25519-X509.der'],
#          'private_key': 'pytls13/src/pytls13/clt_cs/_Ed25519PrivateKey-ed25519-pkcs8.der',
          'sig_scheme': ['ed25519'],
        }
      }
    }
...
#      path = '/index.html'
    ...
    if isinstance( ipaddress.ip_address( ip ),  \
            ( ipaddress.IPv4Address, ipaddress.IPv6Address ) ) is False :
